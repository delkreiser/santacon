...
const EVENT_CONFIG = {
    ...
    schedule: [
        {
            ...
            // Time range in minutes from midnight (for real-time tracking)
            startMinutes: 17 * 60,       // 5:00pm = 1020
            endMinutes: 18 * 60 + 30,    // 6:30pm = 1110
        },
        {
            time: "6:30 - 7:00pm",
            ...
            notes: null,
            startMinutes: 18 * 60 + 30,  // 6:30pm = 1110
            endMinutes: 19 * 60,         // 7:00pm = 1140
        },
        {
            time: "7:00 - 7:45pm",
            ...
            startMinutes: 19 * 60,       // 7:00pm = 1140
            endMinutes: 19 * 60 + 45,    // 7:45pm = 1185
        },
        {
            time: "7:45 - 9:00pm",
            ...
            startMinutes: 19 * 60 + 45,  // 7:45pm = 1185
            endMinutes: 21 * 60,         // 9:00pm = 1260
        },
        {
            time: "9:00 - 1:00am",
            ...
            notes: null,
            startMinutes: 21 * 60,       // 9:00pm = 1260
            endMinutes: 25 * 60,         // 1:00am = 1500
        }
    ],
    ...
    badges: {
        ...
        marathonSanta: {
            ...
            autoUnlockMinutes: 20 * 60 + 15,  // 8:15pm
        },
        superSanta: {
            emoji: "\ud83d\udcaa\ud83c\udffb",
            title: "SUPER SANTA",
    ...
    // -------------------------------------------------------------------------
    lockedQuestTeasers: {
        1020: "3 nearby venues ready to explore\u2014snap photos, grab drinks, and refuel!",   // 5:00pm
        1140: "2 drink destinations with tropical vibes await!",                                // 7:00pm
    },
};
